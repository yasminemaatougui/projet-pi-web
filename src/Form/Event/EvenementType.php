    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('layoutType', ChoiceType::class, [
                ...
                'required' => false,
                'placeholder' => '— Aucun plan de salle —',
                'choices' => [
                    'Théâtre (rangées de sièges)' => 'theatre',
                    'Banquet (tables rondes)' => 'banquet',
                ],
                'attr' => ['class' => 'form-select']
            ])
            ->add('layoutRows', IntegerType::class, [
                'label' => 'Rangées / Tables',
                'required' => false,
                'attr' => ['class' => 'form-control', 'min' => 1, 'placeholder' => 'Ex: 8']
            ])
            ->add('layoutCols', IntegerType::class, [
                'label' => 'Sièges par rangée / par table',
                'required' => false,
                'attr' => ['class' => 'form-control', 'min' => 1, 'placeholder' => 'Ex: 12']
            ])
        ;
    }
